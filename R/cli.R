fastasset_cli_help <- function() {
  paste0(
    ...
    "                                Native trait order is read from $S. Only\n",
    "                                manifest/LDSC-common traits are retained,\n",
    "                                in manifest order; missing traits are audited.\n\n",
    ...
    "  With POPULATION_PREV, LDSC N is per-SNP NC+NCO; SAMPLE_PREV\n",
    "  is median(NC)/(median(NC)+median(NCO)) across valid SNPs.\n",
